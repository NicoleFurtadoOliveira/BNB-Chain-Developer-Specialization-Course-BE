...
contract NFTONCHAIN is ERC721URIStorage{
    ...
    function getTokenURI(uint256 tokenId) public view returns (string memory){ 
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
            '"name": "NFTONCHAIN #', tokenId.toString(), '",',
    ...
    function incrementNumber(uint256 tokenId) public{
        ...
        require(ownerOf(tokenId) == msg.sender, "You must own this token to increment the number!"); 
        uint256 currentNumber = tokenIdToNumber [tokenId];
        tokenIdToNumber[tokenId] = currentNumber +1; _setTokenURI (tokenId, getTokenURI (tokenId));
    }
}